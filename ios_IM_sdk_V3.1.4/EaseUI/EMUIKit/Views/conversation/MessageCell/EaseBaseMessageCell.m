...
#warning EmoKit Add
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.emoLabel attribute:NSLayoutAttributeRight relatedBy:NSLayoutRelationEqual toItem:self.bubbleView attribute:NSLayoutAttributeLeft multiplier:1.0 constant:-EaseMessageCellPadding]];
}
...
#warning EmoKit Add
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.emoLabel attribute:NSLayoutAttributeLeft relatedBy:NSLayoutRelationEqual toItem:self.bubbleView attribute:NSLayoutAttributeRight multiplier:1.0 constant:EaseMessageCellPadding]];
}
